...
namespace UpdateContact
{
    ...
    public class AddContact : SubmitActionBase<UpdateContactData>
    {
      
        /// <summary>
        /// Initializes a new instance of the <see cref="AddContact"/> class.
        /// </summary>
        /// <param name="submitActionData">The submit action data.</param>

        public AddContact(ISubmitActionData submitActionData) : base(submitActionData)
        {
        }
